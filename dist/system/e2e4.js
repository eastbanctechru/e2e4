System.register(['lodash'], function (_export) {
    ...
    return {
        ...
        execute: function () {
            ...
            })(KeyCodes || _export('KeyCodes', KeyCodes = {}));

            _export('MouseButtons', MouseButtons);
            ...
            })(MouseButtons || _export('MouseButtons', MouseButtons = {}));

            _export('ProgressState', ProgressState);
            ...
            })(ProgressState || _export('ProgressState', ProgressState = {}));

            _export('SortDirection', SortDirection);
